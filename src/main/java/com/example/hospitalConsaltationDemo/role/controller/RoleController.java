package com.example.hospitalConsaltationDemo.role.controller;
...
import com.example.hospitalConsaltationDemo.role.service.RoleService;
...
public class RoleController {
    ...
    public ResponseEntity<Response<List<Role>> > getAllRole(){
        return ResponseEntity.ok(roleService.getAllRoleRole());
    }
